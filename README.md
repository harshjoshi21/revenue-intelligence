...
- Latest stable release tag: v2.2.1
- Current development release target: v2.2.2 (on dev)
- main carries stable tagged releases; dev is the active development branch

Supporting release documentation:
- Latest stable release summary: [RELEASE_v2.2.1.md](RELEASE_v2.2.1.md)
- Prior stable release summary: [docs/archive/RELEASE_v2.2.0.md](docs/archive/RELEASE_v2.2.0.md)
...
- Previous stable release summary: [docs/archive/RELEASE_v2.1.0.md](docs/archive/RELEASE_v2.1.0.md)
